...
const LIST_OF_SHOWS = [
    // {
    //     startDate: moment("March 19 23 7 PM", "MMMM DD YY h:mm A"),
    //     endDate: null,
    //     title: "",
    //     location: "",
    //     linkToEvent: "",
    ...
    // },
    {
        startDate: moment("Jan 22 25 6:30 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Poets & Playwrights: a night of queercrip readings ",
        location: "Iron Dog Books, Vancouver",
        linkToEvent: "https://fb.me/e/7QxxAlKur",
        blurb: `Join Under the Table Poetry Collective for a night of queer crip readings at Iron Dog Books! Open mic sign up starts at 6:30 PM with readings beginning at 7:00 PM! We welcome both poets and playwrights to read on the open mic, and we ask that writers limit their readings to 5 minutes.`,
        image: 'poets-and-playwrites.jpg',
        id: 92,
    },
    {
        startDate: moment("September 25 25 7 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Peterborough Poetry Slam Pride & Poetry Open Mic feat. Kay Kassirer & Frankie McGee",
        location: "Dreams of Beans, Peterborough",
        linkToEvent: "https://www.instagram.com/p/DOwgDhZjlz_/",
        blurb: `Thursdays, September 25th The Peterborough Poetry Slam, in partnership with Peterbough Pride, proudly presents PRIDE & POETRY!!! Feature Performances & 2SLGBTQAI+ Open MIC! We are stoked to announce this year we'll be featuring the poetry of @kaykassirer and @frankiemcgeearts and the show will be hosted by Peterborough's very own @taylor.writes.music !!!`,
        image: 'Peterborough.jpg',
        id: 91,
    },
    {
        startDate: moment("Aug 10 23 1:30 pm", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Back Talk: Voices Against Violence",
        location: "Virtual",
        linkToEvent: "https://www.canvasprograms.com/community",
        blurb: `The Back Talk: Voices Against Violence program supports queer youth in using poetry and spoken word to discuss experiences with topics including sexual violence, queerness, and resilience. The Back Talk Collective shares poetry to educate, inspire, and most importantly: Talk Back. The program culminates in the creation of a published chapbook of poems, as well as several performances across the GTA.   The Back Talk program is currently offered to youth at Friends of Ruby every Thursday.`,
        image: 'back-talk.png',
        id: 90,
    },
    {
        startDate: moment("Sep 8 24 3 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Arts AccessAbility Network Manitoba Open Mic",
        location: "Virtual",
        linkToEvent: "https://www.eventbrite.ca/e/aanm-poetry-open-mic-tickets-978374573687",
        blurb: `Join Arts AccessAbility Network Manitoba and Under the Table Poetry for a disability centered virtual poetry open mic featuring Kay Kassirer.`,
        image: 'aanm-open-mic.jpg',
        id: 89,
    },
    {
        startDate: moment("Nov 19 19 7:30 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Incite: Hustling Verse",
        location: "Roundhouse Community Arts & Recreation Centre, 181 Roundhouse Mews, Vancouver, BC",
        linkToEvent: "https://www.facebook.com/events/2401168770156709",
        blurb: `Join the Vancouver Writers Fest and Arsenal Pulp Press on November 19 for a special Incite event celebrating the publication of Hustling Verse: An Anthology of Sex Workers’ Poetry, edited by Amber Dawn and Justin Ducharme. Amber Dawn and Justin Ducharme will be joined by contributors Mercedes Eng, jaye simpson, Kay Kassirer, tzaz, Raven Slander, Cassandra Blanchard, Jan Maudlin, Hysterika and Sumpter.`,
        image: 'incite.jpg',
        id: 88,
    },
    {
        startDate: moment("Jan 13 20 8 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Vancouver Poetry Slam ft. Kay Kassirer",
        location: "Cafe Deux Soleils - 2096 Commercial Drive, Vancouver, British Columbia",
        linkToEvent: "https://www.facebook.com/events/2532757800383337/",
        blurb: `The Vancouver Poetry Slam has been wowing audiences since 1996, making it the longest-running poetry slam in Canada. It is a program of the non-profit organization, Vancouver Poetry House.`,
        image: 'vps.jpg',
        id: 87,
    },
    {
        startDate: moment("May 17 20 8 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "JQT Heritage Month: Showcase",
        location: "Virtual",
        linkToEvent: "https://www.facebook.com/events/554545651755142/554545661755141/",
        blurb: `The month of May is Jewish Heritage Month and JQT Vancouver, pronounced "J-cutie", is a Jewish Queer and Trans* group dedicated to creating connections and seeking space to celebrate our intersectional identities as Jews of all ages of diverse sexual orientations, as well as gender and sex identities, by queering Jewish space and Jewifying queer space in Vancouver, BC.`,
        image: 'jqt.jpg',
        id: 86,
    },
    {
        startDate: moment("Oct 21 20 6 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Artivitism: Sex + The Unheard",
        location: "Virtual",
        linkToEvent: "https://www.facebook.com/events/1246380435718782/",
        blurb: `On October 21st, come out (online) to a virtual Showcase + Open-Mic with UBC Slam Poetry! We will have some incredible feature poets joining us, and anyone is welcome to perform, create, and connect in our passionate and loving community! You can sign up to perform or enjoy other poets’ incredible talents as an audience member.`,
        image: 'artivism.jpg',
        id: 85,
    },
    {
        startDate: moment("Feb 10 21", "MMMM DD YY"),
        endDate: null,
        title: "Tongues of Fire Open Mic ft. Kay Kassirer",
        location: "Virtual",
        linkToEvent: "https://www.facebook.com/events/721824891802140",
        blurb: `Tongues of Fire is our spoken word open mic that happens three times a month on the 2nd, 3rd, and 4th Wednesdays of the month. You'll hear (up to) 5-minute sets from (up to) 12 performers, plus a 25-minute set from our featured poet.`,
        image: 'vpp.png',
        id: 84,
    },

    {
        startDate: moment("June 9 23 7 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Urban Legends Poetry Slam ft. Kay Kassirer",
        location: "Arts Court, 2 Daly Ave, Ottawa",
        linkToEvent: "https://www.eventbrite.ca/e/ulpc-slam-5-ft-kay-kassirer-tickets-645483688087",
        blurb: `Come on out for an in-person poetry slam and open mic in the Atelier Studio at Arts Court. Our feature poet for the night is none other than the fantastic Kay Kassirer!`,
        image: 'ULPC.png',
        id: 83,
    },
    {
        startDate: moment("July 13 23", "MMMM DD YY"),
        endDate: moment("July 16 23", "MMMM DD YY"),
        title: "Saskatchewan Festival of Words (Moose Jaw, SK)",
        location: "Moose Jaw, Saskatchewan",
        linkToEvent: "https://www.festivalofwords.com/",
        blurb: `Celebrating all forms of the written word. Welcoming Canadian authors, poets, and musicians to Moose Jaw for a weekend of book readings, discussions, writing workshops, and more. Join us online or in person. `,
        image: 'sfow.png',
        id: 82,
    },
    {
        startDate: moment("September 5 23 6 PM", "MMMM DD YY h:mm A"),
        endDate: null,
        title: "Under the Table Masks4EastVan Fundraiser Ft. Jane Shi & Kay Kassirer",
        location: "Massy Art Gallery, 23 E Pender St, Vancouver",
        linkToEvent: "https://www.eventbrite.ca/e/under-the-table-masks4eastvan-fundraiser-ft-jane-shi-kay-kassirer-tickets-694176690167",
        blurb: `Under the Table is an open mic series centering disabled and/or queer poets. This series was dreamed up out of a desire to share work, experience art, and connect with community in a covid safer, more accessible, and anti-oppressive space. Partnering with Massy Voices and Kickstart Disability Arts & Culture, Under the Table Open Mic Series will be on the first Tuesday of each month with some events in person at Massy Arts Society and others virtually on zoom.`,
        image: 'under-the-table-jane.png',
        id: 81,
    },
    {
